                   ...
                   coreWindow}
{
    ...
    QLabel *lblSPL = new QLabel(QStringLiteral("spl"));
    QLabel *lblSPS = new QLabel(QStringLiteral("sps"));
...
void CpuWidget::storeToCore() const
{
    /*
    ...
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_AF, mEdtAF->getInt());
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_UBC, mEdtBC->getInt());
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_UDE, mEdtDE->getInt());
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_UHL, mEdtHL->getInt());
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_UIX, mEdtIX->getInt());
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_UIY, mEdtIY->getInt());
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_PC, mEdtPC->getInt());
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_SPS, mEdtSPS->getInt());
    core.set(cemucore::CEMUCORE_PROP_REG, cemucore::CEMUCORE_REG_SPL, mEdtSPL->getInt());
