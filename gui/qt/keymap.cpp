...
// SmartView section
// -----------------
#define KEY(key) smartview_k##key

static const HostKey KEY(enter)[] = { NRM(Return), none };
static const HostKey KEY(2nd)[] = { NRM(F6), none };
static const HostKey KEY(alpha)[] = { NRM(F7), none };
static const HostKey KEY(sto)[] = { MOD(X, Shift, Shift), none };
static const HostKey KEY(clr)[] = { NRM(Backspace), none };
static const HostKey KEY(del)[] = { NRM(Delete), none };

static const HostKey KEY(math)[] = { MOD(A, No, Shift), none };
static const HostKey KEY(apps)[] = { MOD(B, No, Shift), none };
static const HostKey KEY(prgm)[] = { MOD(C, No, Shift), none };
static const HostKey KEY(vars)[] = { MOD(V, Shift, Shift), none };
static const HostKey KEY(stat)[] = { MOD(S, Shift, Shift), none };
static const HostKey KEY(mode)[] = { MOD(M, Shift, Shift), none };
static const HostKey KEY(xton)[] = { MOD(X, Shift, Shift), none };

static const HostKey KEY(neg)[] = { NRM(Underscore), none };
static const HostKey KEY(add)[] = { NRM(Plus), none };
static const HostKey KEY(sub)[] = { NRM(Minus), MOD(W, No, Shift), none };
static const HostKey KEY(mul)[] = { NRM(Asterisk), MOD(R, No, Shift), none };
static const HostKey KEY(div)[] = { NRM(Slash), MOD(M, No, Shift), none };
static const HostKey KEY(pow)[] = { NRM(AsciiCircum), MOD(H, No, Shift), none };

static const HostKey KEY(sq)[] = { MOD(I, No, Shift), none };
static const HostKey KEY(inv)[] = { MOD(D, No, Shift), none };
static const HostKey KEY(ln)[] = { MOD(S, No, Shift), none };
static const HostKey KEY(log)[] = { MOD(N, No, Shift), none };
static const HostKey KEY(sin)[] = { MOD(E, No, Shift), none };
static const HostKey KEY(cos)[] = { MOD(F, No, Shift), none };
static const HostKey KEY(tan)[] = { MOD(G, No, Shift), none };
...
static const HostKey KEY(0)[] = { NRM(0), none };
static const HostKey KEY(1)[] = { NRM(1), MOD(Y, No, Shift), none };
static const HostKey KEY(2)[] = { NRM(2), MOD(Z, No, Shift), none };
static const HostKey KEY(3)[] = { NRM(3), none };
static const HostKey KEY(4)[] = { NRM(4), MOD(T, No, Shift), none };
static const HostKey KEY(5)[] = { NRM(5), MOD(U, No, Shift), none };
static const HostKey KEY(6)[] = { NRM(6), MOD(V, No, Shift), none };
static const HostKey KEY(7)[] = { NRM(7), MOD(O, No, Shift), none };
static const HostKey KEY(8)[] = { NRM(8), MOD(P, No, Shift), none };
static const HostKey KEY(9)[] = { NRM(9), MOD(Q, No, Shift), none };
static const HostKey KEY(dot)[] = { NRM(Period), none };
static const HostKey KEY(comma)[] = { NRM(Comma), MOD(J, No, Shift), none };
static const HostKey KEY(lpar)[] = { NRM(ParenLeft), MOD(K, No, Shift), none };
static const HostKey KEY(rpar)[] = { NRM(ParenRight), MOD(L, No, Shift), none };
...
static const HostKey KEY(trace)[] = { NRM(F4), none };
static const HostKey KEY(graph)[] = { NRM(F5), none };
static const HostKey KEY(on)[] = { NRM(AsciiTilde), none };
