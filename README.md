...
* [Lua scripting](docs/lua-scripting.md) with a script manager, autoload and CLI support, events, conditional breakpoints, zdis bindings, and deterministic-input/TAS helpers
...
Lua scripting uses [Sol2](https://github.com/ThePhD/sol2).
